...
- **Allowed origins corrigées**
  ...
  - Seuls les domaines frontend sont autorisés : `https://cookingrecipes.example.com` et `https://cookingrecipe.example.com`
...
- **PORTAINER_DEPLOY.md** complètement mis à jour avec :
  - Domaines corrects (`cookingrecipes.example.com` et `api.cookingrecipes.example.com`)
  - Images Docker correctes (`your-username/cookingrecipes-api:latest` et `your-username/cookingrecipes-frontend:latest`)
