...
1. Allez sur votre repo GitHub : `https://github.com/YourUsername/cooking_recipes`
...
- **Secret** : `your-username` (votre nom d'utilisateur Docker Hub)
...
6. **Copiez l'URL du webhook** (ex: `https://portainer.example.com/api/webhooks/xxxxx`)
...
### 4.1 Configuration Frontend (cookingrecipes.example.com)

1. **Nginx Proxy Manager** → **Proxy Hosts** (menu de gauche)
2. Cliquez sur **Add Proxy Host**
3. **Details** :
   - **Domain Names** : `cookingrecipes.example.com`
...
- Testez : `https://cookingrecipes.example.com`

### 4.2 Configuration Backend API (cookingrecipes-api.example.com)

1. **Nginx Proxy Manager** → **Proxy Hosts**
2. Cliquez sur **Add Proxy Host**
3. **Details** :
   - **Domain Names** : `cookingrecipes-api.example.com`
   - **Scheme** : `http`
...
✅ **Vérification** :
- Testez : `https://cookingrecipes-api.example.com/health`
...
2. Connectez-vous
3. Allez dans **Web Cloud** → **Domaines** → `example.com`
...
- Testez : `ping cookingrecipes.example.com` (devrait retourner `YOUR_SERVER_IP`)
- Testez : `ping cookingrecipes-api.example.com` (devrait retourner `YOUR_SERVER_IP`)
...
```bash
# Test de santé
curl https://cookingrecipes-api.example.com/health
...
2. Allez sur : `https://cookingrecipes.example.com`
...
4. ✅ Accessible sur `https://cookingrecipes.example.com`
