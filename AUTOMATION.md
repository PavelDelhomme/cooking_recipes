...
3. Copiez l'URL du webhook (ex: `https://portainer.delhomme.ovh/api/webhooks/xxx`)
...
3. Configuration :
   ...
   - **Repository URL** : `https://github.com/PavelDelhomme/cooking_recipes.git`
...
```bash
PORTAINER_URL=http://portainer.delhomme.ovh:9000
...
export PORTAINER_URL=http://portainer.delhomme.ovh:9000
...
docker pull paveldelhomme/cooking-recipe-api:latest
docker pull paveldelhomme/cooking-recipe-frontend:latest
```
